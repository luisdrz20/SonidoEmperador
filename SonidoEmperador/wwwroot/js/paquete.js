...
function loadDataTable() {
    datatable = $('#tblDatos').DataTable({
        "ajax": {
            "url": "/Admin/Paquete/ObtenerTodos"
        },
        "columns": [
            { "data": "nombre" },
            { "data": "descripcion" },
                ...
                "render": function (data) {
                    return `
                        <div class="text-center">
                            <a href="/Admin/Paquete/Upsert/${data}" class="btn btn-success text-white" style="cursor:pointer">
                                <i class="bi bi-pencil-square"></i>
                            </a>
                            <a onclick=Delete("/Admin/Paquete/Delete/${data}") class="btn btn-danger text-white" style="cursor:pointer">

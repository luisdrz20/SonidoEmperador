...
namespace SonidoEmperador.Areas.Cliente.Controllers
{
    ...
    public class PaquetesTIController : Controller
    {
        private readonly ILogger<PaquetesTIController> _logger;
        private readonly IUnidadTrabajo _unidadTrabajo;

        public PaquetesTIController(ILogger<PaquetesTIController> logger, IUnidadTrabajo unidadTrabajo)
        {
            _logger = logger;
            _unidadTrabajo = unidadTrabajo;
        }

        public IActionResult PaquetesTI(int pageNumber = 1, string busqueda = "",

...
namespace SonidoEmperador.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //asiganamos el rol de ususario real al usuario que se esta creando
                    ...
                    else
                    {
                        ...
                        else
                        {
                             ...
                             //por lo cual debemos de eliminar su workspace
